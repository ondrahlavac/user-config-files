...
" Press VD to var_dump($);exit; and place cursor in insert mode to fill the variable name.
map VD ovar_dump($);exit;<Esc>6hi
...
" And here come the special ones by Babant
abbreviate čč $<C-R>
abbreviate thiss $this-><C-R>
abbreviate /// /**<CR> *<CR>*/<Esc>ka<C-R> 
